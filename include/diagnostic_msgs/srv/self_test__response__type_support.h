...
#ifndef DIAGNOSTIC_MSGS__SRV__SELF_TEST__RESPONSE__TYPE_SUPPORT_H_
#define DIAGNOSTIC_MSGS__SRV__SELF_TEST__RESPONSE__TYPE_SUPPORT_H_
...
const rosidl_message_type_support_t *
  ROSIDL_GET_TYPE_SUPPORT_FUNCTION(diagnostic_msgs, srv, SelfTest_Response)();

#if __cplusplus
}
#endif

#endif  // DIAGNOSTIC_MSGS__SRV__SELF_TEST__RESPONSE__TYPE_SUPPORT_H_
