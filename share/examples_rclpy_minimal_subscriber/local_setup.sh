...
: ${AMENT_CURRENT_PREFIX:="/Users/osrf/jenkins/workspace/packaging_osx/ws/install"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_subscriber/environment/path.sh:$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_subscriber/environment/pythonpath.sh"
