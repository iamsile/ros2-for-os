...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/topic_monitor/environment/path.sh:$AMENT_CURRENT_PREFIX/share/topic_monitor/environment/pythonpath.sh"
