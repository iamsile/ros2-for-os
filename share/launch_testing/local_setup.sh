...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/launch_testing/environment/path.sh:$AMENT_CURRENT_PREFIX/share/launch_testing/environment/pythonpath.sh"
