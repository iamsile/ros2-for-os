...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/demo_nodes_py/environment/path.sh:$AMENT_CURRENT_PREFIX/share/demo_nodes_py/environment/pythonpath.sh"
