...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_service/environment/path.sh:$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_service/environment/pythonpath.sh"
