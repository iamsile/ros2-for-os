...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ament_clang_format/environment/path.sh:$AMENT_CURRENT_PREFIX/share/ament_clang_format/environment/pythonpath.sh"
