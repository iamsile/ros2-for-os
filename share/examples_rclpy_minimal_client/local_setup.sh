...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_client/environment/path.sh:$AMENT_CURRENT_PREFIX/share/examples_rclpy_minimal_client/environment/pythonpath.sh"
